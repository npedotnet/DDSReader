...
- (void)setupGL
{
    ...
    _textures[0] = [self createDDSTexture:[[NSBundle mainBundle] pathForResource:@"dds_DXT1" ofType:@"dds"]];
    _textures[1] = [self createDDSTexture:[[NSBundle mainBundle] pathForResource:@"dds_DXT3" ofType:@"dds"]];
    _textures[2] = [self createDDSTexture:[[NSBundle mainBundle] pathForResource:@"dds_DXT5" ofType:@"dds"]];
